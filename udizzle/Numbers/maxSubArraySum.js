/* 
    ...
    Solution Source : http://www.geeksforgeeks.org/largest-sum-contiguous-subarray/
*/
...
console.log(JSON.stringify(my_maxSubArraySum(IDEAL_NEG_INPUT)));